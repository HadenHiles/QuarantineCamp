	...
	<div class="row">
		...
		<div class="ossn-layout-newsfeed">
            ...
            <script src='https://redditjs.com/subreddit.js' data-subreddit='HowToHockey'></script>
						<a href="https://discord.gg/SkKaC9K" target="_blank" id="discordchatimage" style="display: block; padding: 15px 10px 10px 40px;">
							<img src="/themes/QuarantineCamp/images/discord.png" class="normal" style="width: 100%; height: auto;" />
							<img src="/themes/QuarantineCamp/images/discord-dark.png" class="dark" style="width: 100%; height: auto; display: none;" />
						</a>
				</div>
                <?php } ?>
			</div>
