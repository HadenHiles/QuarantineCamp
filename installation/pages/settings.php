...
$password = trim(file_get_contents("/var/www/database_password.raw"));
?>
<form action="<?php echo ossn_installation_paths()->url; ?>?action=install" method="post">
    ...
    <div>
        ...
        <input type="text" value="ossndb"  name="dbuser" placeholder="<?php echo ossn_installation_print('ossn:dbuser'); ?>"/>
        <input type="password" name="dbpwd" value="<?php echo $password;?>" placeholder="<?php echo ossn_installation_print('ossn:dbpassword'); ?>"/>
        <input type="text" name="dbname" value="ossndb"  placeholder="<?php echo ossn_installation_print('ossn:dbname'); ?>"/>
